    ...
    $scope.MakeStandInfo = function(standId) {
        ...
        $ionicPopup.show({
            ...
            template:
                    ...
                    '<div class="row"><a href="' + $scope.stands[fixedId].gsx$kotisivu.$t + '" target="_blank" style="width:60%;display:block;height:40px;line-height:40px;background:white;margin:auto;text-align:center;text-decoration:none;"><div class="btn" style="color:#199cd8;">Lue lisää</div></a></div><br/><br/>',
            buttons: [
                {
                    text: 'Sulje ikkuna'
                }
